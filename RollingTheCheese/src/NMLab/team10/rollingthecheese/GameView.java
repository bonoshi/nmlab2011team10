...
public class GameView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private class Scroll extends Thread {
        ...
        private int decadeDrag() {
            if (posX > rightEdge + 3 * quantizeConst
                ...
                return 0;
                // }else if(posX>rightEdge + 2*quantizeConst||posX<leftEdge -
                // 2*quantizeConst){
                // return (fingerX-prev_fingerX)/5;
                // }else if(posX>rightEdge + 1*quantizeConst||posX<leftEdge -
                // 1*quantizeConst){
    ...
    public void doDraw(Canvas canvas) {
        ...
        synchronized (lock) {
            ...
            canvas.translate(scroll.posX - 160, 0);
